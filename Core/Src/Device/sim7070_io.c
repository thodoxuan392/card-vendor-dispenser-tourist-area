...
static GPIO_info_t sim7060_io_table[] = {
		[SIM7070_PWR] = {GPIOB, { GPIO_PIN_10, GPIO_MODE_OUTPUT_PP, GPIO_PULLDOWN, GPIO_SPEED_FREQ_LOW}},
		[SIM7070_NET] = {GPIOB, { GPIO_PIN_11, GPIO_MODE_INPUT, GPIO_PULLDOWN, GPIO_SPEED_FREQ_LOW}},
};
