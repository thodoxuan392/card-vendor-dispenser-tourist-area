...
static GPIO_info_t gpio_table[] = {
		[TCD_PAYOUT1_IO] = 		{GPIOE, { GPIO_PIN_8, GPIO_MODE_OUTPUT_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_MEDIUM}},
		[TCD_RESET1_IO] = 		{GPIOE,{ GPIO_PIN_9, GPIO_MODE_OUTPUT_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_MEDIUM }},
		[TCD_CALLBACK1_IO] = 	{GPIOE,{ GPIO_PIN_10, GPIO_MODE_OUTPUT_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_MEDIUM }},
		...
		[TCD_PAYOUT2_IO] = 		{GPIOE,{ GPIO_PIN_12, GPIO_MODE_OUTPUT_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_MEDIUM }},
		[TCD_RESET2_IO] = 		{GPIOE,{ GPIO_PIN_13, GPIO_MODE_OUTPUT_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_MEDIUM }},
		[TCD_CALLBACK2_IO] = 	{GPIOE,{ GPIO_PIN_14, GPIO_MODE_OUTPUT_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_MEDIUM }},
