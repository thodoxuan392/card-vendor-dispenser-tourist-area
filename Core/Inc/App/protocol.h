...
typedef enum {
  ...
  PROTOCOL_RESULT_COMM_PROTOCOL_TIMEOUT = 0x13,
  PROTOCOL_RESULT_CMD_RESET_TIMEOUT = 0x14,
  PROTOCOL_RESULT_CMD_TRANSFER_OTA_DATA_IN_PROGRESS = 0x15,
  PROTOCOL_RESULT_CMD_RFID_NOT_AVAILABLE = 0x16,
  PROTOCOL_RESULT_CMD_RFID_INVALID_FORMAT = 0x17,
  PROTOCOL_RESULT_CMD_ID_NOT_MATCHED = 0x18,
  PROTOCOL_RESULT_CMD_AUTHEN_FAILED = 0x19,
  PROTOCOL_RESULT_CMD_CANNOT_WRITE = 0x1A
