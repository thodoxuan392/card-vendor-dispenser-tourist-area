...
typedef enum {
  ...
  PROTOCOL_RESULT_CMD_DISPENSE_CARD_CORRUPT = 0x40,
  PROTOCOL_RESULT_CMD_DISPENSE_CARD_TIMEOUT = 0x41,
  PROTOCOL_RESULT_CMD_DISPENSE_CARD_UPDATE_RFID_FAILED = 0x42,
  PROTOCOL_RESULT_CMD_DISPENSE_CARD_TCD_PAYOUT_FAILED = 0x43,
  PROTOCOL_RESULT_CMD_DISPENSE_CARD_NOT_AVAILABLE = 0x44,
